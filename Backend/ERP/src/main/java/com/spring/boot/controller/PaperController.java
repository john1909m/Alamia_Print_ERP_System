...
public class PaperController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Page<PaperDto>>> getAllPapers(
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Papers retrieved successfully", papers)
        );
    }
    ...
    public ResponseEntity<ApiResponse<PaperDto>> getPaperById(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Paper retrieved successfully", paper)
        );
    }
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<PaperDto>> createPaper(@Valid @RequestBody PaperDto paperDto) {
        ...
        return ResponseEntity.created(location)
                .body(ApiResponse.success("Paper created successfully", savedPaper));
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PaperDto>> updatePaper(@PathVariable Long id, @Valid @RequestBody PaperDto paperDto) {
        PaperDto updatedPaper = paperService.update(id, paperDto);
        return ResponseEntity.ok(
                ApiResponse.success("Paper updated successfully", updatedPaper)
        );
    }
